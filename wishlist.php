...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($check_cart_numbers) > 0){
        ...
        mysqli_query($conn, "INSERT INTO `cart`(user_id, pid, name, price, quantity, image) VALUES('$user_id', '$product_id', '$product_name', '$product_price', '$total_stock', '$product_image')") or die('query failed');
...
<section class="wishlist">
    ...
    <form action="" method="POST" class="box">
        ...
        <div class="stock">Quantity: <?php echo $fetch_wishlist['stock']; ?>/-</div>
        <input type="hidden" name="total_stock" value="<?php echo $fetch_wishlist['stock']; ?>">
